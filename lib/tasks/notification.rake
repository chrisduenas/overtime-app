namespace :notification do
  ...
  task sms: :environment do
    if Time.now.sunday?
      ...
      notification_message = "Please log into the overtime management dashboard to request overtime or confirm your hours for last week: http://overtime-trackr.herokuapp.com "
